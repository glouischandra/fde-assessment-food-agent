...
# -------------------------------------------------------------
# Firestore Client Proxy (Async Loop Resilience)
# -------------------------------------------------------------
...
class AsyncClientProxy:
    def __getattr__(self, name):
        if not FIRESTORE_AVAILABLE or not project_id_global:
            raise RuntimeError("Firestore is not available or not initialized.")
        client = firestore.AsyncClient(project=project_id_global)
